function main () {
    ...
    function clicReproducir () {
        ...
        if(!oMedio.paused && !oMedio.ended) {
            //paramos el vídeo
             ...
             //el bucle para revisar el estado de setInterval
             window.clearInterval(bucle);
         }else{
             //reproducimos el video
             oMedio.play();
             oReproducir.value = 'Pausa';
             //Cada 1seg comprueba el progreso de la barra
    ...
    //Sincronizar la barra de progreso y el funcionamiento del vídeo:
    function estado(){
        if(!oMedio.ended){
