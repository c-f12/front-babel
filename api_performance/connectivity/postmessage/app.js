function app () {
    var messageManager = {
        ...
        getWindows: function(){
            this.pages = {
                //seleccionas el contenido del iframe desde fuera del iframe:
        ...
        sayHello: function(e){
            /*en los btn tenemos una propiedad: data-page. el valor de ese atributo
            se guarda en el object dataset, que recoge todos lo data-loquesea*/
