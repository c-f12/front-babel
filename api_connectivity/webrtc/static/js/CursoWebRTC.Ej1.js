/* Si hemos usado antes CursoWebRTC usamos ese sino un objeto vacío */
var CursoWebRTC = CursoWebRTC || {};

//Patrón Module:

//Ej1 es un método que tiene una function autoejecutable:
CursoWebRTC.Ej1 = (function(C, undefined) {

	/* Todos estos son métodos privados dentro del objeto Ej1. Abajo 
	se retornan para poder usarse fuera */
	var CONSTRAINTS = {
		audio: true,
		video: {
			mandatory: {
	...
	//En el objeto params guarda los punteros a los distintos elementos:
	var params = {};
	...
	//Si navigator.getUserMedia no vale nada,i.e, vale false, nos da error.
	var init = function(){
	...
	//stream - Los datos que recibimos del vídeo
	var gotStream = function(stream){
		params['stream'] = stream;
		//transformacion del stream en URL:
	...
	//Retornamos el valor de todos los métodos (se usan en el HTML):
	 //Si x ej no quisieramos usar el método prepare fuera, no lo retornamos.
	return {
		prepare: prepare,
		init: init,
		stop: stop,
